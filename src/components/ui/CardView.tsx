      ...
      {data.map((item, index) => (
        <div
          ...
          className={cn(
            ...
            'hover:shadow-xl hover:-translate-y-1 hover:border-orange-400/85',
            // Animation
            'animate-fade-in',
            'transform-gpu'
          )}
        ...
        >
          ...
          <div className="flex justify-between items-start mb-4">
            <h3 className="text-lg font-semibold text-orange-500 hover:underline">
          ...
          <div className="space-y-2">
            {fields.slice(1).map((field) => (
              <div key={String(field.key)} className="text-sm">
                <span className="font-medium text-cyan-400">{field.label}:</span>{' '}
